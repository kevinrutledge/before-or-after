...
describe('Network Errors', () => {
  ...
  it('Login Network Error', () => {
    ...
    cy.intercept('POST', '/api/auth/login', { forceNetworkError: true }).as('getDataFailure');
    ...
    it('Highscore leaderboard Network Error', () => {
        cy.intercept('GET', '/api/leaderboard*', { forceNetworkError: true }).as('loadLeaderboardFailure');
    ...
    it('Game page Network Error', () => {
        cy.intercept('POST', '/api/cards/guess', { forceNetworkError: true }).as('loadGameFailure');
